/**
 * Manager Panel Theme Configuration
 * Centralized color and theme settings for the manager interface
 */
...
export interface ManagerThemeConfig {
  gradientColors: {
    from: string;
    to: string;
  };
...
export const MANAGER_THEME: ManagerThemeConfig = {
  gradientColors: {
...
export const MANAGER_USER_INFO = {
  name: 'Manager User',
