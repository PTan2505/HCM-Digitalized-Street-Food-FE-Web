...
import { selectCampaignStatus, selectVendorCampaigns } from '@slices/campaign';

interface VendorCampaignImageModalProps {
  isOpen: boolean;
  onClose: () => void;
  campaign: VendorCampaign | null;
}

export default function VendorCampaignImageModal({
  isOpen,
  onClose,
  campaign: propCampaign,
}: VendorCampaignImageModalProps): JSX.Element | null {
