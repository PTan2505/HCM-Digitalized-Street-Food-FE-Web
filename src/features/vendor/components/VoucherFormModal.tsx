...
// ── Multi-entry schema (mảng các VoucherFormData) ──────────────────────────
...
interface VoucherFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  /** Single mode: gọi với 1 VoucherCreate. Multi mode: gọi với VoucherCreate[] */
...
function VoucherEntry({
  ...
  const sectionDivider = (num: number): React.JSX.Element => (
  ...
  return (
    <div className="rounded-xl border border-gray-100 bg-gray-50/50 p-4">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Thời gian hiệu lực (badge chỉ đọc từ campaign) */}
        <div>
          <label className="mb-1 block text-sm font-semibold text-gray-700">
            Thời gian hiệu lực{' '}
