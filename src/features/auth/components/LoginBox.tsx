...
export const LoginBoxBlur = (props: Props): JSX.Element => {
  return (
    <Box className="flex h-121 w-150 items-center justify-center rounded-[36px] shadow-[0_0_40px_rgba(183,211,189,0.8)]">
      {props.children}
    </Box>
  );
};

export const NewPatientProfileBox = (props: Props): JSX.Element => {
  return (
